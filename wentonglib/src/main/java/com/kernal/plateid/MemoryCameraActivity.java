...
public class MemoryCameraActivity extends Activity implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    private int preWidth = 768;
    private int preHeight = 432;
...
//        recogType = getIntent().getBooleanExtra("camera", false);
    ...
    private void findiew() {
        ...
        manual_input = (Button) findViewById(R.id.manual_input);
...
//		hiddenVirtualButtons(re);
        ...
        //手动输入
        manual_input.setOnClickListener(new OnClickListener() {
            @Override
...
//        parameters.setPreviewSize(768, 432);
        ...
        } else if (getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_AUTOFOCUS)) {

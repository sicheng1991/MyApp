...
//				if ((width < height && height * 3 == width * 4)    //4：3的屏幕
...
//
//					}
//				} else if ((width < height && height * 9 == width * 16)  //16：9的屏幕
...
//							second_previewheight = size.height;
//							if (previewWidth <= second_previewWidth
//									&&second_previewWidth * 9 == second_previewheight * 16) {
//								previewWidth = second_previewWidth;
//								previewheight = second_previewheight;
//								sameProportion = true;
//							}
//						}
//					} else  { //非常规屏幕比   选用与屏幕相同比例的预览分辨率
//						if (size.height <= 960 || size.width <= 1280)
//							
//							second_previewWidth = size.width;
//							second_previewheight = size.height;
...
//			height, false,preWidth,preHeight);
//		} else {
//			if (height < 1080) {
//				camera.stopPreview();
//				camera.setPreviewCallback(null);
//			}
//			myview = new ViewfinderView(MemoryCameraActivity.this, width,
//			height, true,preWidth,preHeight);
//		}
//

...
public class StatusBarUtil {
     ...
     * 修改API
     * @param color 状态栏背景
     * @param isLight  状态栏浅色（黑色字体），深色（白色字体）
     */
    public static void setStatusBar(Activity activity,@ColorInt int color, boolean isLight){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if(isLight){
                ...
                activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_VISIBLE);//切回深色主题
            }
        }
    }

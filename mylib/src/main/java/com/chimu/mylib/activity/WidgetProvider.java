...
import com.chimu.mylib.service.WidgetService;
...
public class WidgetProvider extends AppWidgetProvider {
    ...
    private void updateAllAppWidgets(Context context, AppWidgetManager appWidgetManager, Set set) {
        ...
        while (it.hasNext()) {
            ...
            // 设置显示数字
            remoteView.setTextViewText(R.id.tv_1, String.valueOf(mIndex));

            // 设置点击按钮对应的PendingIntent：即点击按钮时，发送广播。
            remoteView.setOnClickPendingIntent(R.id.btn_reset, getResetPendingIntent(context));
            remoteView.setOnClickPendingIntent(R.id.btn_open, getOpenPendingIntent(context));
    ...
    private PendingIntent getOpenPendingIntent(Context context) {
        Intent intent = new Intent();
        intent.setClass(context, MyCameraActivity.class);
